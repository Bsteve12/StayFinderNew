 ...
 * import com.stayFinder.proyectoFinal.services.userService.interfaces.
 ...
 * "Registra un nuevo usuario (sin lógica avanzada de DTOs por ahora).")
 * 
 * @ApiResponses({
 * 
 ...
 * "Objeto Usuario con los datos", required = true)
 * 
 ...
 * "Autentica un usuario mediante email y contraseña (ejemplo simple).")
 * 
 * @ApiResponses({
 * 
 ...
 * 
 * @io.swagger.v3.oas.annotations.parameters.RequestBody(description =
 * "LoginRequest con email y contrasena", required = true)
 * 
 ...
 * public List<com.stayFinder.proyectoFinal.dto.outputDTO.UsuarioResponseDTO>
 * allUsers() {
